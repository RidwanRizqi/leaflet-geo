...
@EnableJpaRepositories(basePackages = "com.example.leaflet_geo.repository.pbjt", entityManagerFactoryRef = "pbjtEntityManagerFactory", transactionManagerRef = "pbjtTransactionManager")
